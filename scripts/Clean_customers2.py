...
# Show the original data for inspection
print("Original Data:")
df_customers.show(5, truncate=False)

# Remove the first row if it contains the header information
...
# Debug: Show the data after cleaning to ensure it's not empty
